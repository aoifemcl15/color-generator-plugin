...
### Output
Two output files are generated by the `ColorGeneratorPlugin` and accessible as part of the built product. 
These files are not easily accessible directly in the project but you can find them derived data for your project, specifically within the `SourcePackages/plugins/` folder. 

<img width="781" alt="Screenshot 2022-11-18 at 16 57 25" src="https://user-images.githubusercontent.com/53755195/202760873-7e6802ad-41e5-44ee-80ac-cab355106367.png">


### Referencing generated colors programatically 

Once the ColorGeneratorPlugin has built successfully, a Colors.swift file will be accessible as part of the built product. 
It is worth noting that this file is not browsable directly in the project. 
But generated colors can be accessed via the `Colors` enum which will be autogenerated, like so: 
```
view.backgroundColor = Colors.TestView.borderColor
```

## Limitations 
* Currently, we haven't been able to find a way of referencing the generated colours within xib or storyboard files. 
